...
| 3 | 房間總覽 `rooms.html` | `/rooms`、館別篩選、房態篩選、快速入住／延住／付款／退房、下一筆預約 | `rooms`、`activeStays`、`bookings`、付款摘要投影；讀取即時 listener；下一筆預約只由有效未來預約推導 | 保留頂部狀態磚、館別、三欄房卡、金額與快捷按鈕 | 1–2 欄房卡、篩選 chips、卡片 action sheet | **基礎完成；目前是假資料** |
