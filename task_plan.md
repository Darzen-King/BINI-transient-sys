...
- [x] MFA 遺失恢復工作流（管理員重設兩步驟驗證，2026-09-14）；第二位系統管理員已由店家建立（2026-09-14）
- [x] 成本 CRUD（封存取代刪除）
...
- [x] 手機版 320／375／430px 版面驗收（2026-09-14，本機模擬資料預覽逐頁量測：無水平溢位、無標籤擠壓；修正頂列與區塊標題擠壓）
- [ ] 中／EN（2026-09-14 已逐頁掃描並修正原始代碼外露）、MFA、安全規則與衝突處理驗收
- [x] App Check（reCAPTCHA Enterprise）已接入並驗證 token 交換 200（2026-09-14）；觀察期至約 2026-09-28 後再決定強制執行
...
| 決策 | 理由 |
|------|------|
| 人員密碼至少 8 字元且含英文字母與數字 | 店家於 2026-09-14 決定；搭配強制 TOTP 兩步驟驗證 |
